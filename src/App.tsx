            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <Card className="bg-[#0E1322] border border-[#2D6BFF]/50 rounded-3xl p-8 relative overflow-hidden">
                ...
                <Button className="w-full bg-[#2D6BFF] hover:bg-[#1E5AEE]">Buy Pro</Button>
                  <li><a href="mailto:hello@deeptechx.xyz" target="_blank" className="hover:text-white transition-colors">Contact Us</a></li>
              </Card>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li><a href="https://github.com/DeepTechX/skatteforge/" className="hover:text-white transition-colors">GitHub</a></li>
